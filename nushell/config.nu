...
alias econf = ^emacs-nw $"($env.HOME)/.config/emacs/init.el"
alias kconf = ^emacs-nw $"($env.HOME)/.config/kitty/kitty.conf"
alias zconf = ^emacs-nw $"($env.HOME)/.config/zellij/config.kdl"
alias zlay = ^emacs-nw $"($env.HOME)/.config/zellij/layouts/default.kdl"
alias zup = ^zellij
alias wconf = ^emacs-nw $"($env.HOME)/.config/wezterm/wezterm.lua"
alias wezconf = wconf
alias hconf = ^emacs-nw $"($env.HOME)/.config/helix/config.toml"
alias brc = ^emacs-nw $"($env.HOME)/.bashrc"
alias brofile = ^emacs-nw $"($env.HOME)/.bash_profile"
...
alias gconf = ^emacs-nw $"($env.HOME)/.config/ghostty/config"
alias hconf = ^emacs-nw $"($env.HOME)/.config/helix/config.toml"
